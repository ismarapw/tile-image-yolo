...
## Current Limitation
1. Tiling image and feed them to the network will produce model that can only recognize the divided image, not a whole image. So, in the future i want to make a scirpt to automate tile and merge process during inference.
